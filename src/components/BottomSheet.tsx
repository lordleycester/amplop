      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 max-w-[480px] mx-auto bg-white rounded-t-xl z-50 shadow-2xl max-h-[88vh] flex flex-col pb-safe"
            id="sheet-container"
          >
            {/* Grab Handle */}
            <div className="w-10 h-1 bg-gray-300 rounded-full mx-auto my-3 flex-shrink-0" id="sheet-handle" />
